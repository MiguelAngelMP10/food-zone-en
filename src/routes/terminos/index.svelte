					...
					<div class="col">
					  <div class="collapse multi-collapse" id="multiCollapseExample1">
						<div class="card card-body">
							...
							<h5>1. IDENTIDAD Y DOMICILIO DE ON VALTA MEXICO S.A. DE C.V.</h5>
							<p>
								ON VALTA MEXICO S.A. DE C.V., (“responsables”), obtenemos, usamos y almacenamos (en lo sucesivo el “Tratamiento”) los datos personales de usted como titular de las mismos (“Usuario”) nos autoriza. 
							</p>
							<p>
								ON VALTA MEXICO S.A. DE C.V. cuentan con domicilio para efectos del presente Aviso de Privacidad en Acatlán 49 letra “A”, colonia La Paz, Código Postal 72160. 
							</p>
							<h5>
								2. TRATAMIENTO DE LOS DATOS PERSONALES.
							</h5>
							<p>
								ON VALTA MEXICO S.A. DE C.V., será responsable de los datos personales que recabe a través de la aplicación denominada “FoodZone”, salvo por los apartados denominados “Pasarela de Pago” dentro del aplicativo móvil, su página de internet https://foodzone.com (el “Sitio principal de FoodZone”), y sus redes sociales y blogs (las “Facebook, Twitter e Instagram, LinkedIn”), ON VALTA MEXICO S.A. DE C.V., será el responsable de los datos personales que recabe a través del apartado denominado “Contacto” dentro del App Foodzone y en el sitio web, ON VALTA MEXICO S.A. DE C.V., solo será responsable de los datos personales que sean recabados a través de su propia aplicación y el apartado denominado “Formulario de contacto” dentro del App y su página de internet https://foodzone.com. Liberándonos de los datos personales que sean recabados mediante las pasarelas de pago, o el sistema de funcionamiento de comentarios o mensajería redes sociales.
							</p>
							<p>
								Cada uno de los responsables también podrá recabar sus datos personales a través de cualquier otro contacto con Usted, de terceros y de otras fuentes permitidas por ley, tales como terceros, autoridades y sociedades de información crediticia y cada uno será responsable del Tratamiento de los mismos.
							</p>
							<p>
								En caso de que haya proporcionado datos de contacto de terceros como referencias, autorizados, cotitulares, cónyuges, beneficiarios, coacreditados, referencias, garantes, obligados solidarios, avales, fiadores, tutores, proveedores, beneficiarios y demás figuras legales relacionadas con productos y/o servicios de los responsables. Usted garantiza que cuenta con su autorización para proporcionar dichos datos, incluyendo en su caso los datos personales aplicables, y es responsable de comunicar a dichas personas sobre los términos y razones por las cuales los contactaremos y, en su caso, el Tratamiento de sus datos personales conforme al presente Aviso de Privacidad, así como los medios para conocer el contenido íntegro del mismo. Adicionalmente, mediante su consentimiento al presente Aviso de Privacidad, usted ratifica su autorización para que los responsables contacten a dichas personas.
							</p>
							<h5>
								3. DATOS PERSONALES TRATADOS POR LOS RESPONSABLES.
							</h5>
							<p>
							...
							<li>Interacciones con perfiles y comportamientos en las Redes Sociales, los Sitios y las Apps.</li>
							<li>Datos de localización.</li>
							<li>Llamadas a y conversaciones en nuestros centros de llamadas (call centers) o mediante correo electrónico.</li>
							<li>mediante correo electrónico.
								Datos referentes a personas sancionadas o consideradas como incumplidoras por organismos gubernamentales nacionales y extranjeros.
								</li>
							<li>Para las finalidades indicadas en el presente Aviso de Privacidad, los responsables tratan las siguientes categorías de datos personales sensibles:</li>
							<li>Datos de filiación política (Persona Expuesta Políticamente) </li>
							<li>Datos Biométricos.</li>
							<h5>
								4. FINALIDADES DEL TRATAMIENTO PRINCIPALES.
							</h5>
							<p>
								Trataremos los datos personales para las siguientes finalidades:
							</p>
							<li>1.- Mantener, desarrollar, administrar, controlar y cumplir con la relación contractual derivada de la solicitud y/o contratación de nuestros productos y/o servicios.</li>
							<li>2.- Exhibir y/o comercializar productos y/o servicios personalizados en nuestros Sitios y Apps conforme a los intereses y necesidades particulares del Usuario.</li>
							<li>3.- Crear, ordenar, catalogar, clasificar, dividir, separar y almacenar datos y expedientes de los Usuarios. </li>
							<li>4.- Creación y administración de la cuenta de los Usuarios en nuestros Sitios y Apps y verificar, validar y confirmar la identidad de los Usuarios y la información proporcionada por los mismos, internamente o a través de cualquier autoridad o tercero.</li>
							<li>5.- Proporcionar al Usuario información, comunicaciones y notificaciones sobre nuestros Sitios y Apps, nuestros productos y/o servicios y los productos y servicios de terceros exhibidos en nuestros Sitios y Apps y los términos y condiciones aplicables a los mismos.  </li>
							<li>6.- Administrar y procesar pagos, operaciones y transacciones de los Usuarios que utilicen nuestros Sitios y Apps.</li>
							<li>7.- Administrar, desarrollar, dar mantenimiento, personalizar y mejorar nuestros Sitios y Apps, nuestros productos y/o servicios y sistemas operativos y realizar las actividades necesarias para que éstos funcionen de manera óptima y correcta, así como prevenir o detectar fraudes o abusos.  </li>
							<li>8.- Realizar estrategias de mercado y elaboración de segmentación de mercados.</li>
							<li>9.- Realizar encuestas de satisfacción de nuestros productos y/o servicios. </li>
							<li>10.- El ofrecimiento o reconocimiento de ofertas, promociones y beneficios de programas de lealtad y beneficios de los responsables y/o terceros.</li>
							<li>11.- Proporcionarle asesoría, aclaraciones, atención de quejas, servicio al cliente y servicio postventa, así como monitorear la calidad de los mismos mediante la grabación de llamadas y almacenamiento de las conversaciones correspondiente.</li>
							<li>12.- Tener acceso a centrales de riesgo o burós de créditos para conocer su capacidad y comportamiento de pago, así como los estados financieros de los Usuarios.</li>
							<li>13.- Cumplir con cualesquiera disposiciones y obligaciones legales, nacionales o internacionales, aplicables a los Responsables, sus subsidiarias y/o afiliadas, así como para gestionar cualquier proceso judicial o tramitar y responder cualesquier requerimientos o solicitudes de las autoridades. </li>
							<li>14.- Realizar procesos relacionados con restructuras corporativas de los Responsables, tales como la fusión, consolidación, venta, liquidación o transferencia de activos.</li>
							<li>15.- Actividades complementarias necesarias para la realización de los fines anteriores.</li>
							<h5>
								TRATAREMOS LOS DATOS PERSONALES PARA LAS SIGUIENTES FINALIDADES SECUNDARIAS:
							</h5>
							<p>
								1.- Mercadotecnia, publicidad, promoción, prospección comercial, procesos de referencias, la elaboración, valoración y análisis de perfiles de los Usuarios para el desarrollo y ofrecimiento de nuevos productos y servicios, realización de encuestas ajenas a nuestros productos o servicios, fines analíticos y estadísticos, todos ellos relacionados con los productos y servicios de los Responsables, sus afiliadas, subsidiarias, aliados y otros terceros; 
							</p>
							<p>
								2.- Para contactarlo sobre o enviarle información de novedades, noticias, ofertas de los Responsables o terceros, boletines, foros de educación, publicidad o marketing, ventas a distancia, haciendo uso de medios tales como correo electrónico, notificaciones PUSH, mensajes de texto (SMS) y ventanas de diálogo (pop-ups). 
							</p>
							<p>
								En caso de que no desee que sus datos personales sean tratados para estas finalidades secundarias o accesorias, Usted puede enviar desde este momento un correo electrónico a contacto@foodzone.com , siguiendo el procedimiento a que se refiere el numeral 7 del presente Aviso de Privacidad. 
							</p>
							<h5>
								5. OPCIONES Y MEDIOS QUE LE OFRECEMOS PARA LIMITAR EL USO O DIVULGACIÓN DE SUS DATOS PERSONALES.
							</h5>
							<p>
								En todos aquellos casos legalmente procedentes, Usted podrá limitar el uso o divulgación de sus datos personales, presentando una solicitud conforme al procedimiento establecido en el numeral 7 del presente Aviso de Privacidad.
							</p>
							<h5>
							...
							<p>
								3.- A compañías afiliadas o subsidiarias de los Responsables, que operen bajo los mismos procesos y políticas internas de los Responsables, con finalidades de mercadotecnia, publicidad, promoción, prospección comercial, de procesos de referencias, de elaboración, valoración y análisis de perfiles de los Usuarios, de resguardo centralizado de la información, de fines analíticos y estadísticos y de registro histórico de usuarios y de la realización de encuestas referentes a los Responsables, sus subsidiarias y/o afiliadas.
							</p>
							<p>
								4.- A terceros adquirientes, derivado de una reestructura corporativa de uno de los Responsables, incluyendo, la fusión, consolidación, venta, liquidación o transferencia de activos, cuando la transferencia sea necesaria para el mantenimiento o cumplimiento de una relación entre dicho Responsable y el Titular.
							</p>
							<p>
								5.- A terceros que exhiben y comercializan productos y/o servicios o aceptan realizar la gestión de un encargo a través de los Sitios y de las Apps, así como a prestadores de servicios y aliados comerciales, cuando la transferencia sea necesaria para el mantenimiento o cumplimiento de una relación entre uno de los Responsables y el Titular.
							</p>
							<p>
								6.- A terceros que exhiben y comercializan productos y/o servicios o aceptan realizar la gestión de un encargo a través de los Sitios y de las Apps, así como a aliados comerciales, cuando la transferencia sea necesaria por virtud de un contrato celebrado o por celebrar en interés del Titular, por uno de los Responsables y dichos terceros. 
							</p>
							<p>
								7.- A terceros que exhiben y comercializan servicios y/o productos o aceptan realizar la gestión de un encargo a través de los Sitios y de las Apps a través de los Sitios y de las Apps, con la finalidad de dar seguimiento a o realizar actividades relacionadas con cualquier adquisición y entrega de productos y/o servicios a través de los Sitios y de las Apps, así como dar cumplimiento a las obligaciones derivadas de la relación jurídica entre el Titular y dichos terceros.
							</p>
							<p>
								8.- Con base en los demás supuestos establecidos en la Legislación de Datos Personales, que no requieren de su consentimiento.
En caso que así lo autorice el Usuario mediante los Sitios, las Apps o cualquier otro medio aplicable, los Responsables podrán transferir sus datos personales a terceros que exhiben y comercializan productos y/o servicios a través de los Sitios y de las Apps, aliados comerciales y otros aliados estratégicos de los Responsables, para fines mercadológicos, de publicidad o de prospección comercial.
En cualquier caso, de los señalados anteriormente, comunicaremos a los terceros receptores el presente Aviso de Privacidad, con el fin de asegurar que su información se utilice en los términos del mismo.
							...
							<h5>
								7. MEDIOS PARA EL EJERCICIO SUS DERECHOS.
							</h5>
							<p>
								En todos aquellos casos legalmente procedentes, Usted podrá en todo momento y a través del procedimiento establecido en el presente numeral, ejercer ante cada uno de los Responsables los siguientes derechos referentes a sus datos personales: (i) derechos de Acceso, Rectificación, Cancelación y Oposición (“Derechos ARCO”); (ii) revocar el consentimiento otorgado a cada uno de los Responsables para el tratamiento de sus datos personales; (iii) limitar el uso o divulgación de sus datos personales; y (iv) manifestar su negativa para el tratamiento de sus datos personales con respecto a las finalidades secundarias y accesorias antes mencionadas.
							</p>
							<p>
								Para el ejercicio de dichos derechos referentes a sus datos personales deberá presentar la solicitud correspondiente, mediante el correo electrónico legal@foodzone.com con firma autógrafa al calce del mismo, estableciendo como asunto “Ejercicio de derechos sobre datos personales” y acompañando lo siguiente:
							</p>
							<p>
								copia de los documentos que acrediten su identidad (identificación oficial vigente con fotografía) o, en su caso, la representación legal, conforme a los términos establecidos en la Legislación de Datos Personales; y
cualquier otro elemento o documento que facilite la localización de sus datos personales.

							</p>
							<p>
								Le daremos trámite a las solicitudes de los Titulares para el ejercicio de sus derechos referentes a datos personales en un plazo no mayor a 20 (veinte) días hábiles contados a partir de su recepción y realizar requerimiento o subsanar conforme a los tiempos de la Legislación de Datos Personales; los Responsables podrán ampliar este plazo hasta por 20 (veinte) días hábiles más, cuando el caso lo amerite, previa notificación. En caso de que su solicitud resulte procedente, la misma se hará efectiva dentro de los 15 (quince) días hábiles siguientes de nuestra respuesta.
							</p>
							<p>
								Usted podrá obtener la información o datos personales solicitados a través de documentos electrónicos en formatos convencionales o a través de cualquier otro medio legítimo que garantice y acredite el ejercicio efectivo del derecho solicitado.
							</p>
							<p>
								Según se establece anteriormente, los Departamentos de Datos Personales de cada uno de los responsables están a cargo de tramitar cualesquier solicitudes de los titulares para el ejercicio de sus derechos referentes a datos personales y puede ponerse en contacto con los mismos a través del correo electrónico legal@foodzone.com.
							</p>
							<p>
								Los Responsables desean mantener actualizados sus datos personales en todo momento. Por lo anterior, solicitamos su cooperación para comunicarnos oportunamente cualquier cambio que debamos tener en cuenta, para incorporarlo a nuestras bases de datos. Usted garantiza y responde, en cualquier caso, de la veracidad, exactitud, vigencia y autenticidad de sus datos personales o los de cualquier tercero bajo su custodia o representación legal, en el entendido de que cada uno los Responsables cumplirá con lo establecido en la legislación aplicable en relación con los datos de dichos terceros recibidos por uno de los Responsables.
							</p>
							<h5>
								8. MEDIOS QUE PERMITEN RECABAR DATOS PERSONALES DE MANERA AUTOMÁTICA.
							</h5>
							<p>
								Le informamos que los Sitios, las Apps y las Redes Sociales hacen uso de cookies y otras tecnologías, a través de las cuales es posible monitorear automáticamente su comportamiento, brindarle nuestros productos y/o servicios y otorgarle una experiencia optima y personalizada durante el uso de los mismos, así como ofrecerle nuevos productos y servicios basados en sus preferencias. Los datos personales que se recaban a través de estas tecnologías son: dirección IP, sitios web y secciones de los mismos que usted visita desde los Sitios, antes de los Sitios o en páginas relacionadas con los Sitios y las Apps, características de navegador, características de dispositivos, sistema operativo, preferencias de idiomas, URL a las que se hace referencia, información sobre conductas y acciones realizadas en los Sitios y las Apps, información sobre conductas y acciones realizadas mientras nuestra App está abierta, fechas y horas de las visitas a los Sitios o acceso las Apps, secciones o contenido consultadas en los mismos y datos de ubicación y localización del Usuario mientras nuestras Apps estén abierta. 
							</p>
							<p>
								Estas tecnologías pueden deshabilitarse accediendo a la(s) opción(es) de Privacidad y/o Seguridad ubicada(s) en la(s) sección(es) de Opciones, Herramientas, Preferencias de Internet o funciones similares del navegador de Internet que esté utilizando o a través del ícono de configuración, herramientas o similares del dispositivo en el cual esté instalada las Apps; sin embargo, al desactivarlas debe tomar en cuenta que dicha acción podría provocar que no sea capaz de obtener el funcionamiento total que los Sitios y las Apps pudiera ofrecerle. 
							</p>
							<h5>
							...
							<p>
								Nos comprometemos a mantenerlo informado sobre los cambios que pueda sufrir el presente Aviso de Privacidad, a través de los Sitios y de las Apps, en la sección correspondiente de Aviso de Privacidad. 
							</p>
						</div>
					  </div>
					</div>
